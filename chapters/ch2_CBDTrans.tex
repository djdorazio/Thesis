...
\label{ch:CBDTrans}
\let\thefootnote\relax\footnotetext{This section contains text from an article published in Monthly Notices of the Royal Astronomical Society, Volume 459, Issue 3, p.2379-2393 (2016).}
...
of the R3Bp \citep{MDbook}. Here we show that the above transition 
...
phase transition, we follow \cite{Murray:1994} and \cite{MDbook} to
...
\item \textbf{A lopsided, precessing cavity appears:} The
  ...
  assumptions \citep{MacFadyen:2008, ShiKrolik:2012, Noble+2012, 
  ...
  cavity-edge location \citep{ShiKrolik:2012, DHM:2013:MNRAS}.  We
...
%
 \hspace{-15 pt}
\includegraphics[scale=0.31]{figures/ch2/Dens2D_Norb5000_q0p001_alpha0p01_Mach20}& \hspace{-30 pt}
%
 \includegraphics[scale=0.31]{figures/ch2/Dens2D_Norb5000_q0p01_alpha0p01_Mach20} &  \hspace{-30 pt}
%
 \includegraphics[scale=0.31]{figures/ch2/Dens2D_Norb5000_q0p03_alpha0p01_Mach20} \\   \hspace{-15 pt}
 %
 \includegraphics[scale=0.31]{figures/ch2/Dens2D_Norb5000_q0p05_alpha0p01_Mach20} &  \hspace{-30 pt}
%
\includegraphics[scale=0.31]{figures/ch2/Dens2D_Norb5000_q0p1_alpha0p01_Mach20} &   \hspace{-30 pt}
%
...
\begin{figure*}
\begin{center}$
\begin{array}{c c c} \hspace{-0.7cm}
\includegraphics[scale=0.3]{figures/ch2/StdS_100.pdf} & \hspace{-0.6cm}
\includegraphics[scale=0.3]{figures/ch2/StdP_100.pdf} & \hspace{-0.6cm}
\includegraphics[scale=0.3]{figures/ch2/StdTot_100.pdf}
\end{array}$
\end{center}
...
predict. Additionally, \cite{ShiKrolik:2012} show that the growth
...
\label{AppendixA}
We follow \cite{Murray:1994} and \cite{MDbook} to add an external
